export const USER_GET_TOUR = "/home/tour";
export const USER_GET_HOTEL = "/view/hotel";
export const USER_GET_ROOMS = "/get/rooms";
export const USER_VIEW_ROOMS = "/view/room";
export const USER_GET_REVIEW = "/review";
export const USER_GET_RATING = "/rating";
export const USER_VIEW_TOUR = "/view/tour";
export const USER_POST_REVIEW = "/review";
...
export const TOUR_ADMIN_PAGE_TOUR = "/tour";
...
export const ADMIN_APPROVAL = "/admin/approve";
...
export const GET_ORDERS = "/view/order";
export const CANCEL_ORDERS = "/cancel/orders";
export const REFUND_TOUR_ORDERS = "/refund/tour";
export const REFUND_HOTEL_ORDERS = "/refund/hotel";
