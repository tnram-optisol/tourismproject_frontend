          ...
          <MyTable>
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell align="right">
                  {tourOrderExist.bookTour.tour.cost - tourOrderExist.orderCost}
                </TableCell>
              </TableRow>
              <TableRow>
          ...
          <MyTable>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell>{hotelOrderExist.bookRoom.room.room_name}</TableCell>
                <TableCell>
              ...
              <TableRow>
                ...
                <TableCell align="right">{hotelOrderExist.orderCost}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell colSpan={2}>Net Paid </TableCell>
                <TableCell align="right">{hotelOrderExist.orderCost}</TableCell>
